...
/**
 The base class for all Alpha2014 modules
 */
...
/**
 Alpha2014 Platform calls this method on startup.
 */
-(void)startup;

/**
 Alpha2014 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Alpha2014 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Alpha2014 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Alpha2014 Platform calls this method on resume.
 @param sender The sender of the event.
 */
