...
/**
 Base class for all Alpha2014 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Alpha2014 view hierarchy (such as wrapped iOS UIViews) was touched.
