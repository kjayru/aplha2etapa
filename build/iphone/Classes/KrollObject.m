...
//@interface Alpha2014Object : NSObject
//@end

@interface Alpha2014Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Alpha2014Object class]])
		{
			for (NSString *key in [[(Alpha2014Object*)o modules] allKeys])
			{
