...
// in simulator we redefine to format for Alpha2014 Developer console
...
{\
	NSString * exceptionName = [@"org.alpha2014." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alpha2014";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAlpha2014NativeItemNone = -1, 
	UIAlpha2014NativeItemSpinner = -2,
	UIAlpha2014NativeItemProgressBar = -3,
	
	UIAlpha2014NativeItemSlider = -4,
	UIAlpha2014NativeItemSwitch = -5,
	UIAlpha2014NativeItemMultiButton = -6,
	UIAlpha2014NativeItemSegmented = -7,
	
	UIAlpha2014NativeItemTextView = -8,
	UIAlpha2014NativeItemTextField = -9,
	UIAlpha2014NativeItemSearchBar = -10,
	
	UIAlpha2014NativeItemPicker = -11,
	UIAlpha2014NativeItemDatePicker = -12,
	
	UIAlpha2014NativeItemInfoLight = -13,
	UIAlpha2014NativeItemInfoDark = -14,
	
	UIAlpha2014NativeItemDisclosure = -15,
	
	UIAlpha2014NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Alpha2014 instances of
