...
//Rare exceptions to indicate a bug in the _alpha2014 code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_alpha2014 = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_alpha2014]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.alpha2014.module"
